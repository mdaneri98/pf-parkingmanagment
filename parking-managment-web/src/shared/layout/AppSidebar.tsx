...
export function AppSidebar({
  ...
  return (
    <aside className={`${
      ...
      {/* Settings Navigation */}
      <div className={`${sidebarCollapsed ? 'px-2' : 'px-4'} py-3 border-t border-neutral-200/30 dark:border-neutral-700/30`}>
        {renderNavigationItem(settingsItem, sidebarCollapsed)}
      </div>
